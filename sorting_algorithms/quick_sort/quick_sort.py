...
def partition(unsorted_list, first_index, last_index):
    ...
    while not done:
        while left_item_position <= right_item_position and unsorted_list[left_item_position] <= pivot:
            left_item_position = left_item_position + 1
        while unsorted_list[right_item_position] >= pivot and right_item_position >= left_item_position:
        ...
        if right_item_position < left_item_position:
            ...
            unsorted_list[left_item_position] = unsorted_list[right_item_position]
